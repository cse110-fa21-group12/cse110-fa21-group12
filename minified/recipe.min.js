...
console.log(url),
  fetch("/recipes/" + url, {
    ...
    .then((a) => {
      ...
      b.innerHTML = a.title;
      const c = document.getElementsByClassName("description")[0];
      c.innerHTML = a.description;
      const d = document.getElementById("prep-time");
      d.innerHTML = "Preparation Time: " + a.preparationTime;
      const e = document.getElementById("cook-time");
      e.innerHTML = "Cook Time: " + a.cookingTime;
      const f = document.getElementById("total-time");
      f.innerHTML = "Total Time: " + a.totalTime;
      const g = document.getElementById("ingredientsBox");
      for (let b = 0; b < a.ingredients.length; b++) {
        ...
        g.appendChild(c), g.appendChild(d), g.appendChild(e);
      }
