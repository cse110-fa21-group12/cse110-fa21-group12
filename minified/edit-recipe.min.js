...
fetch("/recipes/" + id, {
  ...
  .then((a) => {
    ...
    d.defaultValue = a.categories;
    const e = document.getElementById("tags");
    e.defaultValue = a.tags;
    ...
    for (let b = 0; b < a.ingredients.length; b++) {
      ...
      (c.defaultValue = a.ingredients[b]),
        c.setAttribute("class", "ingredient"),
        d.setAttribute("id", "quantity"),
        (d.placeholder = "Amount"),
        j.appendChild(d),
        j.appendChild(c),
        j.appendChild(document.createElement("br"));
    }
    const k = document.getElementById("enter-directions");
...
saveRecipeButton.addEventListener("click", () => {
  ...
  const m = JSON.stringify({
    ...
    n = document.getElementById("file-ip-1"),
    o = new FormData();
  o.append("json", m),
    o.append("img", n.value),
    fetch("/recipes/edit", { method: "PUT", body: o })
      .then((a) => a.json())
      .then((a) => {
        console.log("Success:", a);
      })
